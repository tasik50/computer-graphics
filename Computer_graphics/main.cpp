...
void displayProposal()
{
    ...
    renderBitmapString(-0.18f, 0.80f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Computer Graphics Project [K]");
    ...
    renderBitmapString(-0.20f, 0.60f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Course teacher: Noboronjan Dey");
    renderBitmapString(-0.5f, 0.50f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Group Members:");

    renderBitmapString(-0.5f, 0.40f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "1.Name: Yasir Arafat Tamim");
    renderBitmapString(-0.5f, 0.30f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "ID: 22-47231-1");

    renderBitmapString(-0.5f, 0.20f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "2.Name: Hasan Mahmud");
    renderBitmapString(-0.5f, 0.10f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "ID: 22-47240-1");

    renderBitmapString(-0.5f, 0.00f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "3.Name: Tasik Ahmed");
    renderBitmapString(-0.5f, -0.10f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "ID: 22-47258-1");

    renderBitmapString(-0.5f, -0.20f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "4.Name: Toufiq Ben Akash");
    renderBitmapString(-0.5f, -0.30f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "ID: 21-45159-2");
